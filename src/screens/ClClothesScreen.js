// src/screens/ClClothesScreen.js
...
export default function ClClothesScreen() {
        ...
        <TouchableOpacity activeOpacity={0.8} style={styles.card}>
            ...
            <View style={styles.cardFooter}>
                <TouchableOpacity style={styles.roundBtn}>
                    <Ionicons name="cart-outline" size={18} color="#1e293b" />
                </TouchableOpacity>
        ...
        <SafeAreaView style={styles.safeArea}>
            ...
            {loading ? (
                <View style={styles.loading}>
                    <Ionicons name="refresh" size={22} color="#32A7AC" />
                    <Text style={{ marginLeft: 6, color: "#32A7AC" }}>Cargando…</Text>
                </View>
            ) : filtered.length === 0 ? (
...
const styles = StyleSheet.create({
    ...
    input: { flex: 1, marginHorizontal: 8, color: "#0f172a" },
    ...
    chipActive: { backgroundColor: "#32A7AC" },
    chipText: { color: "#1e293b", fontSize: 13, fontWeight: "600" },
    ...
    title: { fontSize: 13, color: "#1e293b", paddingHorizontal: 10, paddingTop: 8 },
    price: { fontSize: 13, fontWeight: "700", color: "#32A7AC", paddingHorizontal: 10, paddingTop: 4 },
    cardFooter: {
        flexDirection: "row",
        alignItems: "center",
        justifyContent: "space-between",
